...
static MotionProfile lineWP = {
  .x = { .target = 0.650, .startRate = 0, .endRate = 0, .maxAbsoluteRate = TOP_SPEED, .maxAccel = TOP_ACCEL},
  .y = { .target = 0.000, .startRate = 0, .endRate = 0, .maxAbsoluteRate = TOP_SPEED, .maxAccel = TOP_ACCEL},
  .theta = { .target = 0, .startRate = 0, .endRate = 0, .maxAbsoluteRate = 1 * 3.14, .maxAccel = 4 * 3.14},
  .elevator = 0,
  .pivot = 0,
...
static MotionProfile loadingWP = {
  .x = { .target = -0.350, .startRate = 0, .endRate = 0, .maxAbsoluteRate = TOP_SPEED, .maxAccel = TOP_ACCEL},
  .y = { .target = -0.400, .startRate = 0, .endRate = 0, .maxAbsoluteRate = TOP_SPEED, .maxAccel = TOP_ACCEL},
